...
channel1= ["tradeBin1m:XRPUSD"]
tbl1 = 'bitmex_ticker_xrp'
msg1 = Ws('bitmex').subscr(channel1)
check_table(tbl1, engine, 'bitmex')

channel2= "XRPUSD"
tbl2 = 'bitfinex_ticker_xrp'
msg2 = Ws('bitfinex').subscr(channel2)
check_table(tbl2, engine, 'bitfinex')

channel3= 'XRP-USD'
tbl3 = 'coinbase_ticker_xrp'
msg3 = Ws('coinbase').subscr(channel3)
check_table(tbl3, engine, 'coinbase')

channel4= "XRP-PERP"
tbl4 = 'ftx_ticker_xrp'
msg4 = Ws('ftx').subscr(channel4)
check_table(tbl4, engine, 'ftx')

channel5 = ['XRP/USD']
tbl5 = 'kraken_ticker_xrp'
msg5 = Ws('kraken').subscr(channel5)
check_table(tbl5, engine, 'kraken')

try:
    loop = asyncio.get_event_loop()
    loop.create_task(Ws('bitmex').pubStream(msg1, tbl1))
    loop.create_task(Ws('bitfinex').pubStream(msg2, tbl2))
    loop.create_task(Ws('coinbase').pubStream(msg3, tbl3))
    loop.create_task(Ws('ftx').pubStream(msg4, tbl4))
    loop.create_task(Ws('kraken').pubStream(msg5, tbl5))
    loop.run_forever()
